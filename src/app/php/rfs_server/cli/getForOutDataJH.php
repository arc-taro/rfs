...
function getForOutDataJH($db,$cd) {
...
,jh.update_dt
,jh.update_account
,jh.update_account_nm
,jh.update_busyo_cd
FROM
s_tmp shisetsu 
LEFT JOIN rfs_t_daichou_jh jh
  ON shisetsu.sno = jh.sno 
...
function outputCSVJH($data,$csvDirName,$csv_kihon_header) {
  $csv_daichou_header = [
    'bikou'=>'備考'
    ,'kyoutsuu1'=>'共通1'
    ,'kyoutsuu2'=>'共通2'
