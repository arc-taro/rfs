...
function getForOutDataKD($db,$cd) {
...
, kd.tk_kaisen_kyori
, kd.tk_kaisen_id
, kd.tk_kaisen_kyakuban
, kd.tk_setsuzoku_moto
, kd.tk_setsuzoku_saki
, kd.tk_getsugaku
, kd.tk_waribiki
,kd.d_hokuden_kyakuban
,kd.d_keiyaku_houshiki
,kd.d_kaisen_id
,kd.d_kaisen_kyakuban
,kd.d_hikikomi
,kd.d_denki_dai
,kd.d_denki_ryou
,kd.bikou
...
,kd.update_dt
,kd.update_account
,kd.update_account_nm
,kd.update_busyo_cd
FROM
s_tmp shisetsu 
LEFT JOIN rfs_t_daichou_kd kd 
  ON shisetsu.sno = kd.sno 
...
LEFT JOIN  ( 
  ...
  AND kd.unei_kbn_cd = unei_kbn.unei_kbn_cd
...
function outputCSVKD($data,$csvDirName,$csv_kihon_header) {
  $csv_daichou_header = [
    'unei_kbn_cd'=>'運営区分コード'
    ,'unei_kbn'=>'運営区分'
    ,'tk_kaisen_syu'=>'回線種別'
