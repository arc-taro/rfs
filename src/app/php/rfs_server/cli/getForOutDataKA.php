...
function getForOutDataKA($db,$cd) {
...
, ka.tk_kaisen_kyori
, ka.tk_kaisen_id
, ka.tk_kaisen_kyakuban
, ka.tk_setsuzoku_moto
, ka.tk_setsuzoku_saki
, ka.tk_getsugaku
, ka.tk_waribiki
,ka.d_hokuden_kyakuban
,ka.d_keiyaku_houshiki
,ka.d_kaisen_id
,ka.d_kaisen_kyakuban
,ka.d_hikikomi
,ka.d_denki_dai
,ka.d_denki_ryou
,ka.bikou
...
,ka.update_dt
,ka.update_account
,ka.update_account_nm
, ka.update_busyo_cd
FROM
s_tmp shisetsu 
LEFT JOIN rfs_t_daichou_ka ka 
  ON shisetsu.sno = ka.sno 
...
LEFT JOIN  ( 
  ...
  AND ka.unei_kbn_cd = unei_kbn.unei_kbn_cd
...
function outputCSVKA($data,$csvDirName,$csv_kihon_header) {
  $csv_daichou_header = [
  'unei_kbn_cd'=>'運営区分コード'
  ,'unei_kbn'=>'運営区分'
  ,'tk_kaisen_syu'=>'回線種別'
