...
function getForOutDataKB($db,$cd) {
...
, kb.tk_kaisen_kyori
, kb.tk_kaisen_id
, kb.tk_kaisen_kyakuban
, kb.tk_setsuzoku_moto
, kb.tk_setsuzoku_saki
, kb.tk_getsugaku
, kb.tk_waribiki
,kb.d_hokuden_kyakuban
,kb.d_keiyaku_houshiki
,kb.d_kaisen_id
,kb.d_kaisen_kyakuban
,kb.d_hikikomi
,kb.d_denki_dai
,kb.d_denki_ryou
,kb.bikou
...
,kb.update_dt
,kb.update_account
,kb.update_account_nm
,kb.update_busyo_cd
FROM
s_tmp shisetsu 
LEFT JOIN rfs_t_daichou_kb kb 
  ON shisetsu.sno = kb.sno 
...
LEFT JOIN  ( 
  ...
  AND kb.unei_kbn_cd = unei_kbn.unei_kbn_cd
...
function outputCSVKB($data,$csvDirName,$csv_kihon_header) {
  $csv_daichou_header = [
    'unei_kbn_cd'=>'運営区分コード'
    ,'unei_kbn'=>'運営区分'
    ,'tk_kaisen_syu'=>'回線種別'
