...
function getForOutDataDT($db,$cd) {
...
,dt.update_dt
,dt.update_account
,dt.update_account_nm
,dt.update_busyo_cd
FROM
s_tmp shisetsu 
LEFT JOIN rfs_t_daichou_dt dt 
  ON shisetsu.sno = dt.sno 
...
function outputCSVDT($data,$csvDirName,$csv_kihon_header) {
  $csv_daichou_header = [
