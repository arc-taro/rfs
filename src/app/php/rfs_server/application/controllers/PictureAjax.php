...
//                header("HTTP/1.1 400 Bad Request");
  ...
  public function get_picture() {
    ...
    } else if ($this->post['mode'] == 'zenkei_picture') {
      $data = $this->PictureModel->get_picture_zenkei($this->post);
    } else if ($this->post['mode'] == 'sankou_photo') {
      $data = $this->PictureModel->get_sankou_photo("RFS_CHECK_PHOTO_" . $this->post['chk_mng_no']);
    }
  ...
  public function save_fix_picture() {
    ...
    if (isset($this->post['sankou_photos'])) {
      $this->PictureModel->save_fix_sankou_photo($this->post['sankou_photos'], "RFS_CHECK_PHOTO_" . $this->post['chk_mng_no']);
    }
