...
class FamEditModelTU extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_tu_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
