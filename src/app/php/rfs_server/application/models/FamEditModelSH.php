...
// 台帳:シェッド等登録用
class FamEditModelSH extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_sh_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
