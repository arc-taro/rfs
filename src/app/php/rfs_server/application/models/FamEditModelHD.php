...
// 台帳:歩道登録用
class FamEditModelHD extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_hd_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
