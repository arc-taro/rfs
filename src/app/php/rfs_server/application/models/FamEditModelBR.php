...
// 台帳:橋梁登録用
class FamEditModelBR extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_br_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
