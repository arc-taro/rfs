...
// 台帳:切土登録用
class FamEditModeDK extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_dk_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
