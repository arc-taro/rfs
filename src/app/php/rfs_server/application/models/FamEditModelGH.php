...
// 台帳:岩盤崩壊登録用
class FamEditModelGH extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_gh_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
