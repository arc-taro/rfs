...
// 台帳:道路情報提供装置（門型）登録用
class FamEditModelJM extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_jm_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
