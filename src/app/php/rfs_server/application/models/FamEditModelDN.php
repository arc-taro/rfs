...
// 台帳:法面登録用
class FamEditModelDN extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    log_message('info', "FamEditModelDN->saveDaichou");
    $this->setDaichouCommon($daichou); // 共通
    $this->setItem($daichou); // 擁壁固有
    $sql= <<<SQL
            insert into rfs_t_daichou_dn (
              sno
              , daityou_no
              , genkyou_nendo
              , genkyou_nendo_yyyy
              ...
              , {$daichou['noridaka_kou']}
              , {$daichou['noridaka_tei']}
              , {$daichou['norimen_koubai']}
              , {$daichou['norimen_menseki']}
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_dn_pkey
            DO UPDATE SET
              ...
              ,noridaka_kou = {$daichou['noridaka_kou']}
              ,noridaka_tei = {$daichou['noridaka_tei']}
              ,norimen_koubai = {$daichou['norimen_koubai']}
              ,norimen_menseki = {$daichou['norimen_menseki']}
...
SQL;
  ...
  protected function setItem(&$daichou) {
    ...
    $daichou['noridaka_kou']=$this->chkItem($daichou,'noridaka_kou',1);
    $daichou['noridaka_tei']=$this->chkItem($daichou,'noridaka_tei',1);
    $daichou['norimen_koubai']=$this->chkItem($daichou,'norimen_koubai',2);
    $daichou['norimen_menseki']=$this->chkItem($daichou,'norimen_menseki',1);
