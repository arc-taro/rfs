...
// 台帳:大型カルバート登録用
class FamEditModelCL extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_cl_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
