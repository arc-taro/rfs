...
// 台帳:横断歩道橋登録用
class FamEditModelFB extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_fb_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
