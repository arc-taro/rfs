...
// 台帳:道路標識（門型）登録用
class FamEditModelDM extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_dm_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
