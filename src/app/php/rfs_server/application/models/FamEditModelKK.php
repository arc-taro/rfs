...
// 台帳:急流河川登録用
class FamEditModelKK extends FamEditModel {
  ...
  public function saveDaichou($daichou) {
    ...
    $sql= <<<SQL
            ...
            ON CONFLICT ON CONSTRAINT rfs_t_daichou_kk_pkey
            DO UPDATE SET
              bikou = {$daichou['bikou']}
